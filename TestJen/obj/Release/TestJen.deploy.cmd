...
set _DeploySetParametersFile=%RootPath%TestJen.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%TestJen.zip" (
echo "%RootPath%TestJen.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%TestJen.deploy-readme.txt" (
...
start notepad "%RootPath%TestJen.deploy-readme.txt"
)
echo =========================================================
goto :eof
